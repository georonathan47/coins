...
SellHistoryModel sellHistoryModelFromJson(String str) =>
    SellHistoryModel.fromJson(json.decode(str));

String sellHistoryModelToJson(SellHistoryModel data) =>
